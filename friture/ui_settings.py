...
class Ui_Settings_Dialog(object):
    def setupUi(self, Settings_Dialog):
        ...
        self.label_inputType = QtWidgets.QLabel(parent=self.inputGroup)
        self.label_inputType.setObjectName("label_inputType")
        self.verticalLayout_3.addWidget(self.label_inputType)
        self.radioButton_single = QtWidgets.QRadioButton(parent=self.inputGroup)
        ...
        self.radioButton_duo = QtWidgets.QRadioButton(parent=self.inputGroup)
        ...
        self.groupBox_first = QtWidgets.QGroupBox(parent=self.inputGroup)
        self.groupBox_first.setObjectName("groupBox_first")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.groupBox_first)
        self.verticalLayout.setObjectName("verticalLayout")
        self.comboBox_firstChannel = QtWidgets.QComboBox(parent=self.groupBox_first)
        ...
        self.groupBox_second = QtWidgets.QGroupBox(parent=self.inputGroup)
        ...
        self.comboBox_secondChannel = QtWidgets.QComboBox(parent=self.groupBox_second)
        ...
        self.playbackGroup = QtWidgets.QGroupBox(parent=Settings_Dialog)
        ...
        self.label_showPlayback = QtWidgets.QLabel(parent=self.playbackGroup)
        self.label_showPlayback.setObjectName("label_showPlayback")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_showPlayback)
        self.checkbox_showPlayback = QtWidgets.QCheckBox(parent=self.playbackGroup)
        self.checkbox_showPlayback.setText("")
        self.checkbox_showPlayback.setObjectName("checkbox_showPlayback")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.checkbox_showPlayback)
        self.label_historyLength = QtWidgets.QLabel(parent=self.playbackGroup)
        self.label_historyLength.setObjectName("label_historyLength")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_historyLength)
        self.spinBox_historyLength = QtWidgets.QSpinBox(parent=self.playbackGroup)
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.spinBox_historyLength)
        self.verticalLayout_5.addWidget(self.playbackGroup)
        self.themeGroup = QtWidgets.QGroupBox(parent=Settings_Dialog)
        self.themeGroup.setObjectName("themeGroup")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.themeGroup)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.radioButton_themeSystem = QtWidgets.QRadioButton(parent=self.themeGroup)
        self.radioButton_themeSystem.setChecked(True)
        self.radioButton_themeSystem.setObjectName("radioButton_themeSystem")
        self.themeButtonGroup = QtWidgets.QButtonGroup(Settings_Dialog)
        self.themeButtonGroup.setObjectName("themeButtonGroup")
        self.themeButtonGroup.addButton(self.radioButton_themeSystem)
        self.verticalLayout_7.addWidget(self.radioButton_themeSystem)
        self.radioButton_themeLight = QtWidgets.QRadioButton(parent=self.themeGroup)
        self.radioButton_themeLight.setObjectName("radioButton_themeLight")
        self.themeButtonGroup.addButton(self.radioButton_themeLight)
        self.verticalLayout_7.addWidget(self.radioButton_themeLight)
        self.radioButton_themeDark = QtWidgets.QRadioButton(parent=self.themeGroup)
        self.radioButton_themeDark.setObjectName("radioButton_themeDark")
        self.themeButtonGroup.addButton(self.radioButton_themeDark)
        self.verticalLayout_7.addWidget(self.radioButton_themeDark)
    ...
    def retranslateUi(self, Settings_Dialog):
        ...
        self.themeGroup.setTitle(_translate("Settings_Dialog", "Theme"))
        self.radioButton_themeSystem.setText(_translate("Settings_Dialog", "System"))
        self.radioButton_themeLight.setText(_translate("Settings_Dialog", "Light"))
        self.radioButton_themeDark.setText(_translate("Settings_Dialog", "Dark"))
