/* Generated by Cython 0.17.2 on Sun Jun 02 00:09:22 2013 */
...
static char __pyx_k_15[] = "pyx_exp_smoothed_value";
static char __pyx_k_16[] = "C:\\Users\\timothee\\Documents\\dev\\friture\\friture\\friture\\extension\\exp_smoothing_conv.pyx";
static char __pyx_k_17[] = "friture.exp_smoothing_conv";
static char __pyx_k_20[] = "pyx_exp_smoothed_value_numpy";
 ...
 */
  ...
  /* "friture/extension/exp_smoothing_conv.pyx":42
 * 	cdef Py_ssize_t i, j
 * 	cdef np.ndarray[dtype_t, ndim=1] value, conv
 ...
 * 	# as we disable the cython bounds checking, do it by ourselves
 */
  __pyx_v_a = pow((1. - __pyx_v_alpha), ((__pyx_t_7friture_18exp_smoothing_conv_dtype_t)__pyx_v_N));
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "friture/extension/exp_smoothing_conv.pyx":47
 * 	# it is absolutely needed as the kernel is not of infinite size !!
 * 	if N > Nk:
 * 		N = Nk             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "friture/extension/exp_smoothing_conv.pyx":50
 * 
 * 	if N == 0:
 * 		return previous             # <<<<<<<<<<<<<<
 * 	else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "friture/extension/exp_smoothing_conv.pyx":52
 * 		return previous
 * 	else:
 * 		conv = np.zeros(Nf)             # <<<<<<<<<<<<<<
 * 		value = np.zeros(Nf)
 ...
 */
    ...
    __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_Nf); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    ...
    __pyx_t_2 = 0;
    __pyx_t_2 = PyObject_Call(__pyx_t_3, ((PyObject *)__pyx_t_4), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    ...
    __pyx_t_5 = ((PyArrayObject *)__pyx_t_2);
    {
      ...
      __pyx_t_6 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_conv.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_7friture_18exp_smoothing_conv_dtype_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_6 < 0)) {
        PyErr_Fetch(&__pyx_t_7, &__pyx_t_8, &__pyx_t_9);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_conv.rcbuffer->pybuffer, (PyObject*)__pyx_v_conv, &__Pyx_TypeInfo_nn___pyx_t_7friture_18exp_smoothing_conv_dtype_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_4 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__zeros); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_Nf); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    ...
    __pyx_t_5 = ((PyArrayObject *)__pyx_t_2);
    {
      ...
      __pyx_t_6 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_value.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_7friture_18exp_smoothing_conv_dtype_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_6 < 0)) {
        PyErr_Fetch(&__pyx_t_9, &__pyx_t_8, &__pyx_t_7);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_value.rcbuffer->pybuffer, (PyObject*)__pyx_v_value, &__Pyx_TypeInfo_nn___pyx_t_7friture_18exp_smoothing_conv_dtype_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
    ...
    /* "friture/extension/exp_smoothing_conv.pyx":55
 * 		value = np.zeros(Nf)
 * 
 * 		for i in range(0, N):             # <<<<<<<<<<<<<<
 * 			for j in range(Nf):
 ...
 * 
 */
      __pyx_t_12 = __pyx_v_Nf;
      for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
        __pyx_v_j = __pyx_t_13;

        /* "friture/extension/exp_smoothing_conv.pyx":57
 * 		for i in range(0, N):
 * 			for j in range(Nf):
 * 				conv[j] = conv[j] + kernel[Nk - N + i]*data[j, i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_6 = -1;
        if (__pyx_t_14 < 0) {
          __pyx_t_14 += __pyx_pybuffernd_conv.diminfo[0].shape;
          if (unlikely(__pyx_t_14 < 0)) __pyx_t_6 = 0;
        } else if (unlikely(__pyx_t_14 >= __pyx_pybuffernd_conv.diminfo[0].shape)) __pyx_t_6 = 0;
        if (unlikely(__pyx_t_6 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_6);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_t_15 = ((__pyx_v_Nk - __pyx_v_N) + __pyx_v_i);
        __pyx_t_6 = -1;
        if (__pyx_t_15 < 0) {
          __pyx_t_15 += __pyx_pybuffernd_kernel.diminfo[0].shape;
          if (unlikely(__pyx_t_15 < 0)) __pyx_t_6 = 0;
        } else if (unlikely(__pyx_t_15 >= __pyx_pybuffernd_kernel.diminfo[0].shape)) __pyx_t_6 = 0;
        if (unlikely(__pyx_t_6 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_6);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        ...
        } else if (unlikely(__pyx_t_16 >= __pyx_pybuffernd_data.diminfo[0].shape)) __pyx_t_6 = 0;
        if (__pyx_t_17 < 0) {
          __pyx_t_17 += __pyx_pybuffernd_data.diminfo[1].shape;
          if (unlikely(__pyx_t_17 < 0)) __pyx_t_6 = 1;
        } else if (unlikely(__pyx_t_17 >= __pyx_pybuffernd_data.diminfo[1].shape)) __pyx_t_6 = 1;
        if (unlikely(__pyx_t_6 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_6);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        ...
        __pyx_t_6 = -1;
        if (__pyx_t_18 < 0) {
          __pyx_t_18 += __pyx_pybuffernd_conv.diminfo[0].shape;
          if (unlikely(__pyx_t_18 < 0)) __pyx_t_6 = 0;
        } else if (unlikely(__pyx_t_18 >= __pyx_pybuffernd_conv.diminfo[0].shape)) __pyx_t_6 = 0;
        if (unlikely(__pyx_t_6 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_6);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *__Pyx_BufPtrStrided1d(__pyx_t_7friture_18exp_smoothing_conv_dtype_t *, __pyx_pybuffernd_conv.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_conv.diminfo[0].strides) = ((*__Pyx_BufPtrStrided1d(__pyx_t_7friture_18exp_smoothing_conv_dtype_t *, __pyx_pybuffernd_conv.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_conv.diminfo[0].strides)) + ((*__Pyx_BufPtrStrided1d(__pyx_t_7friture_18exp_smoothing_conv_dtype_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_kernel.diminfo[0].strides)) * (*__Pyx_BufPtrStrided2d(__pyx_t_7friture_18exp_smoothing_conv_dtype_t *, __pyx_pybuffernd_data.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_data.diminfo[0].strides, __pyx_t_17, __pyx_pybuffernd_data.diminfo[1].strides))));
      }
    }

    /* "friture/extension/exp_smoothing_conv.pyx":59
 * 				conv[j] = conv[j] + kernel[Nk - N + i]*data[j, i]
 * 
 * 		for j in range(Nf):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      ...
      /* "friture/extension/exp_smoothing_conv.pyx":60
 * 
 * 		for j in range(Nf):
 * 			value[j] = alpha * conv[j] + previous[j]*a             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_6 = -1;
      if (__pyx_t_12 < 0) {
        __pyx_t_12 += __pyx_pybuffernd_conv.diminfo[0].shape;
        if (unlikely(__pyx_t_12 < 0)) __pyx_t_6 = 0;
      } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_conv.diminfo[0].shape)) __pyx_t_6 = 0;
      if (unlikely(__pyx_t_6 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_6);
      ...
      } else if (unlikely(__pyx_t_13 >= __pyx_pybuffernd_previous.diminfo[0].shape)) __pyx_t_6 = 0;
      if (unlikely(__pyx_t_6 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_6);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      ...
      __pyx_t_6 = -1;
      if (__pyx_t_19 < 0) {
        __pyx_t_19 += __pyx_pybuffernd_value.diminfo[0].shape;
        if (unlikely(__pyx_t_19 < 0)) __pyx_t_6 = 0;
      } else if (unlikely(__pyx_t_19 >= __pyx_pybuffernd_value.diminfo[0].shape)) __pyx_t_6 = 0;
      if (unlikely(__pyx_t_6 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_6);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      *__Pyx_BufPtrStrided1d(__pyx_t_7friture_18exp_smoothing_conv_dtype_t *, __pyx_pybuffernd_value.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_value.diminfo[0].strides) = ((__pyx_v_alpha * (*__Pyx_BufPtrStrided1d(__pyx_t_7friture_18exp_smoothing_conv_dtype_t *, __pyx_pybuffernd_conv.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_conv.diminfo[0].strides))) + ((*__Pyx_BufPtrStrided1d(__pyx_t_7friture_18exp_smoothing_conv_dtype_t *, __pyx_pybuffernd_previous.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_previous.diminfo[0].strides)) * __pyx_v_a));
    }

    /* "friture/extension/exp_smoothing_conv.pyx":62
 * 			value[j] = alpha * conv[j] + previous[j]*a
 * 
 * 		return value             # <<<<<<<<<<<<<<
 */
 ...
 * 	cdef Py_ssize_t Nk = kernel.shape[0]
 */
  __pyx_k_tuple_13 = PyTuple_New(9); if (unlikely(!__pyx_k_tuple_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_13);
  __Pyx_INCREF(((PyObject *)__pyx_n_s__kernel));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 0, ((PyObject *)__pyx_n_s__kernel));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__kernel));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__alpha));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 1, ((PyObject *)__pyx_n_s__alpha));
  ...
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 3, ((PyObject *)__pyx_n_s__previous));
  ...
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 5, ((PyObject *)__pyx_n_s__Nk));
 ...
 * 	cdef Py_ssize_t Nf = data.shape[0]
 */
  __pyx_k_tuple_18 = PyTuple_New(12); if (unlikely(!__pyx_k_tuple_18)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_18);
  __Pyx_INCREF(((PyObject *)__pyx_n_s__kernel));
  PyTuple_SET_ITEM(__pyx_k_tuple_18, 0, ((PyObject *)__pyx_n_s__kernel));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__kernel));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__alpha));
  PyTuple_SET_ITEM(__pyx_k_tuple_18, 1, ((PyObject *)__pyx_n_s__alpha));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__alpha));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__data));
  PyTuple_SET_ITEM(__pyx_k_tuple_18, 2, ((PyObject *)__pyx_n_s__data));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__data));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__previous));
  PyTuple_SET_ITEM(__pyx_k_tuple_18, 3, ((PyObject *)__pyx_n_s__previous));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__previous));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__N));
  PyTuple_SET_ITEM(__pyx_k_tuple_18, 4, ((PyObject *)__pyx_n_s__N));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__N));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__Nf));
  PyTuple_SET_ITEM(__pyx_k_tuple_18, 5, ((PyObject *)__pyx_n_s__Nf));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__Nf));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__Nk));
  PyTuple_SET_ITEM(__pyx_k_tuple_18, 6, ((PyObject *)__pyx_n_s__Nk));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__Nk));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__i));
  ...
  __Pyx_INCREF(((PyObject *)__pyx_n_s__value));
  PyTuple_SET_ITEM(__pyx_k_tuple_18, 9, ((PyObject *)__pyx_n_s__value));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__value));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__conv));
  PyTuple_SET_ITEM(__pyx_k_tuple_18, 10, ((PyObject *)__pyx_n_s__conv));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__conv));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__a));
  PyTuple_SET_ITEM(__pyx_k_tuple_18, 11, ((PyObject *)__pyx_n_s__a));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__a));
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_18));
  __pyx_k_codeobj_19 = (PyObject*)__Pyx_PyCode_New(4, 0, 12, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_18, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_16, __pyx_n_s_20, 36, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_19)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 * 	cdef Py_ssize_t Nk = kernel.shape[0]
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_7friture_18exp_smoothing_conv_1pyx_exp_smoothed_value, NULL, __pyx_n_s_17); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_15, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 	cdef Py_ssize_t Nf = data.shape[0]
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_7friture_18exp_smoothing_conv_3pyx_exp_smoothed_value_numpy, NULL, __pyx_n_s_17); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_20, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
