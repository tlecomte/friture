/* Generated by Cython 0.12.1 on Tue Feb  1 11:33:54 2011 */
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_7friture_18exp_smoothing_conv_dtype_t = { "friture.exp_smoothing_conv.dtype_t", NULL, sizeof(__pyx_t_7friture_18exp_smoothing_conv_dtype_t), 'R' };
...
/* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":13
...
static PyObject *__pyx_pf_7friture_18exp_smoothing_conv_pyx_exp_smoothed_value(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_7friture_18exp_smoothing_conv_pyx_exp_smoothed_value(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("pyx_exp_smoothed_value");
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "pyx_exp_smoothed_value") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    ...
    __pyx_v_kernel = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 0));
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_alpha == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_data = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 2));
    __pyx_v_previous = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 3)); if (unlikely((__pyx_v_previous == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("friture.exp_smoothing_conv.pyx_exp_smoothed_value");
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_data), __pyx_ptype_5numpy_ndarray, 1, "data", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_kernel, (PyObject*)__pyx_v_kernel, &__Pyx_TypeInfo_nn___pyx_t_7friture_18exp_smoothing_conv_dtype_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_kernel = __pyx_bstruct_kernel.strides[0];
  __pyx_bshape_0_kernel = __pyx_bstruct_kernel.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_data, (PyObject*)__pyx_v_data, &__Pyx_TypeInfo_nn___pyx_t_7friture_18exp_smoothing_conv_dtype_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_data = __pyx_bstruct_data.strides[0];
  __pyx_bshape_0_data = __pyx_bstruct_data.shape[0];

  /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":14
 * 
 * def pyx_exp_smoothed_value(np.ndarray[dtype_t, ndim=1] kernel, dtype_t alpha, np.ndarray[dtype_t, ndim=1] data, dtype_t previous):
 * 	cdef Py_ssize_t N = data.shape[0]             # <<<<<<<<<<<<<<
 * 	cdef Py_ssize_t Nk = kernel.shape[0]
 ...
 */
  ...
  /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":15
 * def pyx_exp_smoothed_value(np.ndarray[dtype_t, ndim=1] kernel, dtype_t alpha, np.ndarray[dtype_t, ndim=1] data, dtype_t previous):
 * 	cdef Py_ssize_t N = data.shape[0]
 * 	cdef Py_ssize_t Nk = kernel.shape[0]             # <<<<<<<<<<<<<<
 * 	cdef Py_ssize_t i
 ...
 */
  ...
  /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":21
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":22
 * 	# it is absolutely needed as the kernel is not of infinite size !!
 * 	if N > Nk:
 * 		N = Nk             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":24
 * 		N = Nk
 * 
 * 	if N == 0:             # <<<<<<<<<<<<<<
 * 		value = previous
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":25
 * 
 * 	if N == 0:
 * 		value = previous             # <<<<<<<<<<<<<<
 * 	else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":27
 * 		value = previous
 * 	else:
 * 		conv = 0.             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":29
 * 		conv = 0.
 * 
 * 		for i in range(0, N):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":30
 * 
 * 		for i in range(0, N):
 * 			conv = conv + kernel[Nk - N + i]*data[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_5 = __pyx_v_i;
      __pyx_v_conv = (__pyx_v_conv + ((*__Pyx_BufPtrStrided1d(__pyx_t_7friture_18exp_smoothing_conv_dtype_t *, __pyx_bstruct_kernel.buf, __pyx_t_4, __pyx_bstride_0_kernel)) * (*__Pyx_BufPtrStrided1d(__pyx_t_7friture_18exp_smoothing_conv_dtype_t *, __pyx_bstruct_data.buf, __pyx_t_5, __pyx_bstride_0_data))));
    }

    /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":32
 * 			conv = conv + kernel[Nk - N + i]*data[i]
 * 
 * 		value = alpha * conv + previous*(1.-alpha)**N             # <<<<<<<<<<<<<<
 * 
 * 	return value
 */
    __pyx_v_value = ((__pyx_v_alpha * __pyx_v_conv) + (__pyx_v_previous * pow((1.0 - __pyx_v_alpha), __pyx_v_N)));
  }
  __pyx_L7:;

  /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":34
 * 		value = alpha * conv + previous*(1.-alpha)**N
 * 
 * 	return value             # <<<<<<<<<<<<<<
 */
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("pyx_exp_smoothed_value"), (PyCFunction)__pyx_pf_7friture_18exp_smoothing_conv_pyx_exp_smoothed_value, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_exp_smoothing_conv(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("exp_smoothing_conv"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
 */
  ...
  /* "/home/timothee/src/friture/friture/friture/extension/exp_smoothing_conv.pyx":6
 * # see INSTALL
 * 
 * dtype = np.float64             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init friture.exp_smoothing_conv");
