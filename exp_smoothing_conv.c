/* Generated by Cython 0.13 on Sun Jan 09 18:55:14 2011 */
 ...
 */
  ...
  /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":23
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":24
 * 	# it is absolutely needed as the kernel is not of infinite size !!
 * 	if N > Nk:
 * 		N = Nk             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":27
 * 
 * 	if N == 0:
 * 		value = previous             # <<<<<<<<<<<<<<
 * 	else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":29
 * 		value = previous
 * 	else:
 * 		conv = 0.             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":32
 * 
 * 		for i in range(0, N):
 * 			conv = conv + kernel[Nk - N + i]*data[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":34
 * 			conv = conv + kernel[Nk - N + i]*data[i]
 * 
 * 		value = alpha * conv + previous*(1.-alpha)**N             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":36
 * 		value = alpha * conv + previous*(1.-alpha)**N
 * 
 * 	return value             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_6 = PyFloat_FromDouble(__pyx_v_value); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
