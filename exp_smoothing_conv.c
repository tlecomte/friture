/* Generated by Cython 0.13 on Sun Jan 09 18:45:41 2011 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__exp_smoothing_conv
#include "stdio.h"
#include "stdlib.h"
...
typedef __pyx_t_5numpy_float64_t __pyx_t_18exp_smoothing_conv_dtype_t;
...
/* Module declarations from exp_smoothing_conv */

static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_18exp_smoothing_conv_dtype_t = { "dtype_t", NULL, sizeof(__pyx_t_18exp_smoothing_conv_dtype_t), 'R' };
#define __Pyx_MODULE_NAME "exp_smoothing_conv"
int __pyx_module_is_main_exp_smoothing_conv = 0;

/* Implementation of exp_smoothing_conv */
...
/* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":15
...
static PyObject *__pyx_pf_18exp_smoothing_conv_pyx_exp_smoothed_value(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_18exp_smoothing_conv_pyx_exp_smoothed_value(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_kernel = 0;
  __pyx_t_18exp_smoothing_conv_dtype_t __pyx_v_alpha;
  PyArrayObject *__pyx_v_data = 0;
  __pyx_t_18exp_smoothing_conv_dtype_t __pyx_v_previous;
  Py_ssize_t __pyx_v_N;
  Py_ssize_t __pyx_v_Nk;
  Py_ssize_t __pyx_v_i;
  __pyx_t_18exp_smoothing_conv_dtype_t __pyx_v_value;
  __pyx_t_18exp_smoothing_conv_dtype_t __pyx_v_conv;
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("pyx_exp_smoothed_value", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__data);
      if (likely(values[2])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("pyx_exp_smoothed_value", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  3:
      values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__previous);
      if (likely(values[3])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("pyx_exp_smoothed_value", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "pyx_exp_smoothed_value") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_kernel = ((PyArrayObject *)values[0]);
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_alpha == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_data = ((PyArrayObject *)values[2]);
    __pyx_v_previous = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_previous == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
    goto __pyx_L5_argtuple_error;
  } else {
    __pyx_v_kernel = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 0));
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_alpha == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_data = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 2));
    __pyx_v_previous = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 3)); if (unlikely((__pyx_v_previous == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("pyx_exp_smoothed_value", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("exp_smoothing_conv.pyx_exp_smoothed_value");
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_bstruct_kernel.buf = NULL;
  __pyx_bstruct_data.buf = NULL;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_kernel), __pyx_ptype_5numpy_ndarray, 1, "kernel", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_data), __pyx_ptype_5numpy_ndarray, 1, "data", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_kernel, (PyObject*)__pyx_v_kernel, &__Pyx_TypeInfo_nn___pyx_t_18exp_smoothing_conv_dtype_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_kernel = __pyx_bstruct_kernel.strides[0];
  __pyx_bshape_0_kernel = __pyx_bstruct_kernel.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_data, (PyObject*)__pyx_v_data, &__Pyx_TypeInfo_nn___pyx_t_18exp_smoothing_conv_dtype_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_data = __pyx_bstruct_data.strides[0];
  __pyx_bshape_0_data = __pyx_bstruct_data.shape[0];

  /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":16
 * 
 * def pyx_exp_smoothed_value(np.ndarray[dtype_t, ndim=1] kernel, dtype_t alpha, np.ndarray[dtype_t, ndim=1] data, dtype_t previous):
 * 	cdef Py_ssize_t N = data.shape[0]             # <<<<<<<<<<<<<<
 * 	cdef Py_ssize_t Nk = kernel.shape[0]
 ...
 */
  ...
  /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":17
 * def pyx_exp_smoothed_value(np.ndarray[dtype_t, ndim=1] kernel, dtype_t alpha, np.ndarray[dtype_t, ndim=1] data, dtype_t previous):
 * 	cdef Py_ssize_t N = data.shape[0]
 * 	cdef Py_ssize_t Nk = kernel.shape[0]             # <<<<<<<<<<<<<<
 * 	cdef Py_ssize_t i
 ...
 */
  ...
  /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":21
 * 	cdef dtype_t value, conv
 * 
 * 	if N > Nk:             # <<<<<<<<<<<<<<
 * 		N = Nk
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":22
 * 
 * 	if N > Nk:
 * 		N = Nk             # <<<<<<<<<<<<<<
 * 	#print N, Nk
 ...
 */
  ...
  /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":25
 * 	#print N, Nk
 * 
 * 	if N == 0:             # <<<<<<<<<<<<<<
 * 		value = previous
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":26
 * 
 * 	if N == 0:
 * 		value = previous             # <<<<<<<<<<<<<<
 * 	else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":28
 * 		value = previous
 * 	else:
 * 		conv = 0.             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":30
 * 		conv = 0.
 * 
 * 		for i in range(0, N):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":31
 * 
 * 		for i in range(0, N):
 * 			conv = conv + kernel[Nk - N + i]*data[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_5 = __pyx_v_i;
      __pyx_v_conv = (__pyx_v_conv + ((*__Pyx_BufPtrStrided1d(__pyx_t_18exp_smoothing_conv_dtype_t *, __pyx_bstruct_kernel.buf, __pyx_t_4, __pyx_bstride_0_kernel)) * (*__Pyx_BufPtrStrided1d(__pyx_t_18exp_smoothing_conv_dtype_t *, __pyx_bstruct_data.buf, __pyx_t_5, __pyx_bstride_0_data))));
    }

    /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":33
 * 			conv = conv + kernel[Nk - N + i]*data[i]
 * 
 * 		value = alpha * conv + previous*(1.-alpha)**N             # <<<<<<<<<<<<<<
 * 
 * 	return value
 */
    __pyx_v_value = ((__pyx_v_alpha * __pyx_v_conv) + (__pyx_v_previous * pow((1. - __pyx_v_alpha), __pyx_v_N)));
  }
  __pyx_L7:;

  /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":35
 * 		value = alpha * conv + previous*(1.-alpha)**N
 * 
 * 	return value             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_6 = PyFloat_FromDouble(__pyx_v_value); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("pyx_exp_smoothed_value"), (PyCFunction)__pyx_pf_18exp_smoothing_conv_pyx_exp_smoothed_value, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  if (__pyx_module_is_main_exp_smoothing_conv) {
  ...
  /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
 */
  ...
  /* "c:\Users\timothee\Documents\dev\friture\friture\exp_smoothing_conv.pyx":8
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init exp_smoothing_conv");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init exp_smoothing_conv");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
