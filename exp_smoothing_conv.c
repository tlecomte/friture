/* Generated by Cython 0.12.1 on Tue Dec 28 14:13:27 2010 */
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_18exp_smoothing_conv_dtype_t = { "exp_smoothing_conv.dtype_t", NULL, sizeof(__pyx_t_18exp_smoothing_conv_dtype_t), 'R' };
...
/* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":15
...
static PyObject *__pyx_pf_18exp_smoothing_conv_pyx_exp_smoothed_value(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":16
 * 
 * def pyx_exp_smoothed_value(np.ndarray[dtype_t, ndim=1] kernel, dtype_t alpha, np.ndarray[dtype_t, ndim=1] data, dtype_t previous):
 * 	cdef Py_ssize_t N = data.shape[0]             # <<<<<<<<<<<<<<
 * 	cdef Py_ssize_t Nk = kernel.shape[0]
 ...
 */
  ...
  /* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":17
 * def pyx_exp_smoothed_value(np.ndarray[dtype_t, ndim=1] kernel, dtype_t alpha, np.ndarray[dtype_t, ndim=1] data, dtype_t previous):
 * 	cdef Py_ssize_t N = data.shape[0]
 * 	cdef Py_ssize_t Nk = kernel.shape[0]             # <<<<<<<<<<<<<<
 * 	cdef Py_ssize_t i
 ...
 */
  ...
  /* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":21
 * 	cdef dtype_t value, conv
 * 
 * 	if N == 0:             # <<<<<<<<<<<<<<
 * 		value = previous
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":22
 * 
 * 	if N == 0:
 * 		value = previous             # <<<<<<<<<<<<<<
 * 	else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":24
 * 		value = previous
 * 	else:
 * 		conv = 0.             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":26
 * 		conv = 0.
 * 
 * 		for i in range(0, N):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":27
 * 
 * 		for i in range(0, N):
 * 			conv = conv + kernel[Nk - N + i]*data[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":29
 * 			conv = conv + kernel[Nk - N + i]*data[i]
 * 
 * 		value = alpha * conv + previous*(1.-alpha)**N             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":31
 * 		value = alpha * conv + previous*(1.-alpha)**N
 * 
 * 	return value             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_6 = PyFloat_FromDouble(__pyx_v_value); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  /* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
 */
  ...
  /* "/home/timothee/src/friture/friture/exp_smoothing_conv.pyx":8
